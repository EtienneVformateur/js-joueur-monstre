...
function fightClick(){
    ...
    niveauLabel.textContent = joueur1.niveau;
    experienceProgress.value = joueur1.experience;
    experienceValue.textContent = joueur1.experience + "%";
    fights.textContent = ++ nbFight ;
}